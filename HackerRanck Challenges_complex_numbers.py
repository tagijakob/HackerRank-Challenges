...
# you have to print the result of their addition, subtraction,
# multiplication, division and modulus operations.
#
# The real and imaginary precision part should be correct
...
class Complex(object):
    ...
    def __truediv__(self, no):
        denom = no.imaginary*no.imaginary + no.real*no.real
        real = self.real*no.real + self.imaginary*no.imaginary
        im = self.imaginary*no.real - self.real*no.imaginary
        return Complex(real/denom, im/denom)
